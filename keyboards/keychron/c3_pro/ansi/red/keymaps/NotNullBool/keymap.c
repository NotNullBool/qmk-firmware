...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE_PROGRAMMING] = LAYOUT_tkl_ansi(
        _______,             _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,           _______,    _______,  _______,  _______,  _______,
        _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,           _______,    _______,  _______,  _______,  _______,
        _______,   LSFT_T(KC_1),     LSFT_T(KC_2),     LSFT_T(KC_3),     LSFT_T(KC_4),     LSFT_T(KC_5),     LSFT_T(KC_LBRC),  LSFT_T(KC_RBRC), LSFT_T(KC_SCLN),     LSFT_T(KC_SCLN),   LSFT_T(KC_NUBS),  _______,           _______,    _______,  _______,  _______,  _______,
        ...
        _______,   LSFT_T(KC_DOT),   LSFT_T(KC_PPLS),  LSFT_T(KC_PMNS),  LSFT_T(KC_PAST),  LSFT_T(KC_PSLS),  LSFT_T(KC_QUOT),  LSFT_T(KC_GRV),  LSFT_T(KC_COMM),     LSFT_T(KC_DOT),    LSFT_T(KC_SLSH),                       _______,            _______,
        _______,   _______,  _______,                                _______,                                _______,  _______,  _______,    _______,  _______,  _______,  _______
    ),
