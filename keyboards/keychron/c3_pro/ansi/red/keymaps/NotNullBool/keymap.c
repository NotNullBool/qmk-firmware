...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_tkl_ansi(
        ...
        TT(NAV),   LGUI_T(KC_A), LALT_T(KC_R), LSFT_T(KC_S), LCTL_T(KC_T), KC_G,     KC_M,     RCTL_T(KC_N), RSFT_T(KC_E), LALT_T(KC_I), RGUI_T(KC_O), KC_QUOT,               RSFT_T(KC_ENT),
    ...
    [NAV] = LAYOUT_tkl_ansi(
        _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,
        _______,  KC_1,  KC_2,  KC_3,  KC_MINS,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,
        _______,  LGUI_T(KC_4),  LALT_T(KC_5),  LSFT_T(KC_6),  LCTL_T(KC_0),  KC_BACKSLASH, _______, RCTL_T(KC_LEFT),  RSFT_T(KC_DOWN),  LALT_T(KC_UP),    RGUI_T(KC_RIGHT),   _______,              _______,
